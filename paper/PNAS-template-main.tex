...
\begin{enumerate}
 ...
 %\item How does the number of distinct communities and their size scale with %the numbers of developers and connections?
\end{enumerate}
...
%\subsubsection{How does the number of distinct communities and their size scale %with the numbers of developers and connections}
%
...
%\subsection{How does the number of distinct communities and their size scale %with the numbers of developers and connections}
%
